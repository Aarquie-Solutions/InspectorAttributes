...
namespace AarquieSolutions.InspectorAttributes.Editor
{
	public abstract class PropertyDrawerBase : PropertyDrawer
	{
		...
		{
			float indentLength = InspectorAttributeEditorGUI.GetIndentLength(rect);
			...
			InspectorAttributeEditorGUI.HelpBox(helpBoxRect, message, MessageType.Warning, context: property.serializedObject.targetObject);
